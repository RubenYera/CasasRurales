 ...
 */
final class Version20220210083648 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE valoracion (id INT AUTO_INCREMENT NOT NULL, nota_limpieza INT NOT NULL, nota_ubicacion INT NOT NULL, nota_instalaciones_servicios INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
